...
export const propItems = {
    ...
    input: [
        ...
        { name: 'type', def: '', type: 't,s', notStyle: true, vals: ['', 'text', 'checkbox', 'radio', "button", "color", "date", "datetime-local", "email", "file", "hidden", "image", "month", "number", "password", "range", "reset", "search", "submit", "tel", "text", "time", "url", "week",], },
        { name: "value", def: '', type: 't', notStyle: true },
        { name: "checked", def: '', type: 'b', notStyle: true },
        { name: 'borderRadius', def: '', type: 't', },
    ...
    p: [
        ...
        { name: 'background', def: '', type: 't,c' },
        { name: 'color', def: 'red', type: 't,c' },
        { name: 'align', def: '', type: 't,s', vals: ['', 'left', 'center', 'right'] },
        { name: 'padding', def: '', type: 't,n', },
        { name: 'margin', def: '', type: 't,n', },
        { name: 'disabled', def: '', type: 'b', notStyle: true },
    ],
